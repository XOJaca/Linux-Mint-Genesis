...
Automação do meu ambiente Linux Mint após uma instalação limpa, deixando o sistema mais bonito e pronto para uso com alguns programas, configurações e personalizações bases favoritas.
